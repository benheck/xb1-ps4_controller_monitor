...
uint8_t eventTOF[64];          //Flag for if this event should wait a for Time of Flight reading after it has been triggered
uint8_t eventTOFflag = 0;      //Flag that gets set if a T is found at the end of a command line (sets TOF flag for that event)
